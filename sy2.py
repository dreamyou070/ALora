...
origin_query_list = [torch.randn(8*8,1280), torch.randn(16*16, 1280),
                     torch.randn(32*32,640), torch.randn(64*64, 320),]
global_query = gquery_transformer(origin_query_list) # 1,64*64, 768
pi, pisi = global_query
# pixi input to the unet mid block
print(f'pi : {pi.shape}')