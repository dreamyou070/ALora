...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.max_train_epochs):
        ...
        if is_main_process:
            ...
            scratch_vae_save_dir = os.path.join(args.output_dir, 'vae_models')
            os.makedirs(scratch_vae_save_dir, exist_ok = True)
            model_save(accelerator.unwrap_model(scratch_vae),
                       save_dtype,
                       os.path.join(scratch_vae_save_dir, f'vae_{epoch + 1}.safetensors'))
